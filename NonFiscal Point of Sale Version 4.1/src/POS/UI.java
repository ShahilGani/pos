...
public class UI{
    ...
    JButton btnSelect, btnSaveOrder, btnVoid, btnSearch, btnPrintRcpt, btnLastTrans, btnDiscount;
    ...
    public UI() {
     ...
     // Adding bottom panel with session ID and username
        ...
        JLabel lblSessionID = new JLabel("Session ID: 12345");
        lblSessionID.setFont(sf);
        lblSessionID.setForeground(Color.WHITE);
        bottomPanel.add(lblSessionID);

        JLabel lblUsername = new JLabel("Username: User123");
     ...
     // Create the right-side panel
        ...
        rightGbc.gridx = 0;
        rightGbc.gridy = 0;
        rightPanel.add(btnDiscount, rightGbc);
